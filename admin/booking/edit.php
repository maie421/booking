...
<div class="container">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3 bg-white">
            <form action="/ajax/booking/updateAdminBooking.php" method="post">
                ...
                <div class="form-group  mb-3">
                    <label for="exampleFormControlSelect1">숙박 여부</label>
                    <select class="form-select" aria-label="Default select example" name="booking_status">
                        <option value="complete" <?= $booking_date['booking_status'] == 'complete' ? 'selected' : '' ?>>
                            숙박 완료
                        </option>
                        <option value="incomplete" <?= $booking_date['booking_status'] == 'incomplete' ? 'selected' : '' ?>>
                            숙박 미완료
                        </option>
                    </select>
                </div>
