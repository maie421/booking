...
$num = $booking->getBookingByRoomMemberCodeFilterCount(COMMON::getSession('member_code'), $_GET['type']);
        ...
        <ul class="pagination justify-content-center">
            <li class="page-item">
                ...
                <?php
                    ...
                    <a class="page-link" href="?page=<?= $page - 1 ?><?= empty($type) ? '' : "&type=$type" ?>"
                       aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                <?php
            ...
            for ($print_page = $s_pageNum; $print_page <= $e_pageNum; $print_page++) {
                ...
                <li class="page-item"><a class="page-link"
                                         href="?page=<?= $print_page ?><?= empty($type) ? '' : "&type=$type" ?>"><?= $print_page ?></a>
                </li>
            <?php
            } ?>
            <li class="page-item">
                ...
                if ($page >= $total_page) {
                    ?>
                    <a class="page-link" href="?page=<?= $total_page ?><?= empty($type) ? '' : "&type=$type" ?>"
                       aria-label="Next">
