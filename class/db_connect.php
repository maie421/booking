...
class DB_CONNECT
{
    private $dbHost = "127.0.0.1";    // 호스트 주소(localhost, 120.0.0.1)
    private $dbName = "booking";      // 데이타 베이스(DataBase) 이름
    ...
    function __construct()
    {
        try {
            ...
            $this->pdo = new PDO('mysql:host=192.168.64.1', $this->user, $this->password);
